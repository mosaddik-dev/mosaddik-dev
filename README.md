...
I enjoy working close to the engineering layer — writing clean logic, integrating APIs, optimizing data flows, and making products that scale beyond templates.

💼 Currently working as a **Wix Velo Developer**, delivering production-grade solutions for real clients.  
...
- Node.js
- Express.js
- REST API integration & custom backend logic

**Wix Ecosystem**
- Wix Velo (Frontend + Backend)
- Wix CLI & Custom Apps
- Database modeling & permissions
...
- Writing more structured, scalable JavaScript

---

### 💬 Ask Me About
- Wix Velo (beginner → advanced)
- Custom Wix apps via CLI
